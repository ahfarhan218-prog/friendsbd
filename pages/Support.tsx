...
const Support: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-120px)] md:h-[calc(100vh-64px)] bg-slate-50 w-full max-w-5xl mx-auto overflow-hidden md:rounded-3xl md:border md:border-slate-100 md:shadow-sm">
