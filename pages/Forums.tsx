  ...
  return (
    <div className="min-h-screen bg-[#0B0B1A] font-inter pb-24">
      ...
      <div className="px-5 -mt-12 space-y-4 pb-24">
        <div className="bg-[#1C1C2E] p-4 rounded-2xl flex items-center gap-3 border border-white/5 focus-within:border-purple-500/30 transition-colors">
        ...
        {categories.map((cat) => {
          ...
          return (
            <motion.button key={cat.id} whileTap={{ scale: 0.98 }}
              ...
              className="w-full bg-[#1C1C2E] p-5 rounded-[2rem] border border-white/5 flex items-center gap-5 hover:border-purple-500/30 transition-all text-left shadow-md">
