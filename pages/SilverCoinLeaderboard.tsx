  ...
  return (
    <div className="min-h-screen bg-transparent font-inter pb-32">
      <header className="bg-slate-600 text-white p-6 pb-20 rounded-b-[4rem] shadow-xl text-center relative overflow-hidden">
        ...
        <h1 className="text-xs font-black uppercase tracking-[0.5em] text-slate-400 mb-2 mt-4">Silver Rank</h1>
      ...
      <div className="px-5 -mt-10 space-y-4 relative z-10">
         <div className="bg-white rounded-[3rem] p-6 shadow-xl border border-slate-200">
