        ...
        <div className="bg-[#161b22]/80 backdrop-blur-xl rounded-[3rem] p-8 shadow-2xl border border-[#30363d] relative overflow-hidden">
           ...
           <div className="flex justify-between items-center mb-10 relative z-10">
              <div className="flex flex-col items-center">
                 ...
                 <p className="text-[10px] font-black text-white mt-3 uppercase tracking-tighter drop-shadow-md">DHAKA TIGERS</p>
                 <span className="text-[8px] bg-emerald-900/40 text-emerald-300 px-3 py-1 rounded-full font-black mt-2 uppercase border border-emerald-500/30">Batting</span>
              </div>
              ...
              <div className="text-center px-4">
                 <div className="bg-[#090d16]/90 px-6 py-4 rounded-[2rem] shadow-inner border border-[#30363d] mb-3 relative overflow-hidden">
                    ...
                    <p className="text-[10px] uppercase font-black tracking-[0.3em] text-slate-500 mb-1">SCORE</p>
                 ...
                 <p className="text-[10px] font-black text-indigo-400 uppercase tracking-widest bg-indigo-900/20 py-1.5 rounded-full border border-indigo-500/20">
              ...
              <div className="flex flex-col items-center">
                 ...
                 <p className="text-[10px] font-black text-slate-500 mt-3 uppercase tracking-tighter group-hover:text-white transition-colors">SYLHET STRIKERS</p>
                 <span className="text-[8px] text-amber-500/50 font-black mt-2 uppercase tracking-widest border border-amber-500/20 px-3 py-1 rounded-full bg-amber-900/10">Wait..</span>
              </div>
           </div>
           ...
           <div className="grid grid-cols-2 gap-4 relative z-10">
             ...
             <div className="bg-[#090d16]/60 p-5 rounded-[2rem] border border-[#30363d] shadow-inner hover:border-indigo-500/30 transition-colors">
                <p className="text-[8px] font-black text-slate-500 uppercase tracking-[0.2em] mb-1">Current Bowler</p>
           ...
           <div className="space-y-4">
              ...
              <div className="flex gap-4 items-start p-4 bg-[#090d16]/60 rounded-[2rem] border border-[#30363d] shadow-inner group transition-all hover:bg-white/5">
                 ...
                 <div>
                    ...
                    <p className="text-[9px] text-slate-500 mt-2 uppercase font-black tracking-widest">Over 5.1 • Ball 1</p>
                 </div>
              </div>
           </div>
        </div>
