      ...
      <header className="relative bg-[#090d16]/80 backdrop-blur-xl border-b border-[#30363d] pt-12 pb-24 px-3 sm:px-6 rounded-b-[4rem] shadow-xl overflow-hidden shrink-0">
        ...
        <div className="relative z-10 flex justify-between items-center mb-8">
           ...
           <div className="text-center">
             ...
             <p className="text-sm font-black uppercase tracking-widest text-slate-400">High Frequency Event</p>
           </div>
        ...
        <div className="relative z-10 flex flex-col items-center">
            <div className="bg-[#161b22]/80 rounded-3xl p-4 sm:p-6 sm:p-8 backdrop-blur-xl border border-[#30363d] shadow-2xl shadow-cyan-900/20 text-center w-full max-w-[400px]">
              <AnimatePresence mode="wait">
                {isActive ? (
                  ...
                  <div className="py-6">
                     ...
                     <p className="text-sm font-black text-cyan-400/70 uppercase tracking-widest">Scanning local nodes...</p>
                  ...
                  <div className="py-6 space-y-4">
                     ...
                     <p className="text-sm font-bold text-slate-400 uppercase tracking-widest max-w-[200px] mx-auto">
               ...
               {winners.length > 0 ? winners.map((w, idx) => (
                  <div key={idx} className="flex items-center justify-between p-3 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 hover:border-cyan-500/30 transition-all group">
                     <div className="flex flex-wrap items-center gap-3">
                        ...
                        <div>
                           <p className="text-sm font-black text-white group-hover:text-cyan-300 transition-colors">{w.username}</p>
                     ...
                     <div className="flex flex-col items-end gap-1">
                        ...
                        <span className="text-sm font-black text-purple-400 bg-purple-500/10 border border-purple-500/20 px-2 py-0.5 rounded-lg">+5 AP</span>
                     </div>
                  </div>
               )) : (
