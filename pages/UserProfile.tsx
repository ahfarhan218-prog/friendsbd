          ...
          <div className="lg:w-80 shrink-0">
            ...
            <div className="pf-card p-6 text-center">
              ...
              <div className="flex gap-2 mt-5">
                {!isOwnProfile ? (
                  <>
                    <button onClick={() => navigate('/chat?userId=' + profile.id)} className="pf-btn pf-btn-primary flex-1 flex items-center justify-center gap-1.5">
                    ...
                    <button onClick={handleFollow} className={`pf-btn flex-1 flex items-center justify-center gap-1.5 ${isFollowing ? 'pf-btn-ghost' : 'pf-btn-follow'}`}>
                      {isFollowing ? (
