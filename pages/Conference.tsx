...
const Conference: React.FC = () => {
  ...
  return (
    <div className="h-screen bg-[#0F0F1A] flex flex-col font-inter text-white overflow-x-hidden" style={{ backgroundImage: 'radial-gradient(ellipse at 50% 0%, rgba(124, 58, 237, 0.15) 0%, transparent 70%), linear-gradient(135deg, #110a2a 0%, #1d0d4a 50%, #0d1a6b 100%)' }}>
