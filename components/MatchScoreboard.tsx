    ...
    <div className="bg-slate-900 text-white rounded-xl p-4 mb-4 shadow-xl border border-slate-700 font-mono relative overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="flex justify-between items-center border-b border-slate-700 pb-3 mb-3">
          ...
          <span className="text-xs font-bold text-purple-400 uppercase bg-purple-900/30 px-2 py-1 rounded-md border border-purple-800/50">
        ...
        {latestLog && (
          <div className="mt-4 pt-3 border-t border-slate-700/50">
            <p className="text-xs text-slate-400 mb-1 font-bold uppercase tracking-wider">Latest Action</p>
